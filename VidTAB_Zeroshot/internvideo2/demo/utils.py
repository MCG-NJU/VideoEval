...
from internvideo2.models.backbones.internvideo2 import pretrain_internvideo2_1b_patch14_224
from internvideo2.models.backbones.bert.builder import build_bert
from internvideo2.models.criterions import get_sim
from internvideo2.models.backbones.internvideo2.pos_embed import interpolate_pos_embed_internvideo2_new
from internvideo2.models.backbones.bert.tokenization_bert import BertTokenizer
...
def retrieve_text(frames_tensor, 
                  texts, 
                  model,
                  topk:int=5,
                  config: dict={},
