...
available_corpus = dict(
    ...
    # debug
    cc3m_debug=dict(
        anno_path="/mnt/petrelfs/share_data/videointern/annotations/anno_pretrain_lkc/cc3m_debug.json",
        data_root="p2:s3://GCC",
        media_type="image"
    ),
    webvid_debug=dict(
        anno_path="/mnt/petrelfs/share_data/videointern/annotations/anno_pretrain_lkc/webvid_debug.json",
        data_root="s3://video_pub/WebVid2M",
        media_type="video"
    )
)
...
available_corpus["msrvtt_1k_test"] = dict(
    # anno_path="your_path", 
    # data_root="",
    anno_path="/mnt/petrelfs/share_data/videointern/annotations/anno_downstream/msrvtt_test1k.json", 
    data_root="p2:s3://MSR-VTT/MSRVTT_Videos",
    media_type="video"
)
...
available_corpus["didemo_ret_test"] = dict(
    # anno_path="your_path", 
    # data_root="",
    anno_path="/mnt/petrelfs/share_data/videointern/annotations/anno_downstream/didemo_ret_test.json", 
...
available_corpus["anet_ret_val"] = dict(
    # anno_path="your_path", 
    # data_root="",
    anno_path="/mnt/petrelfs/share_data/videointern/annotations/anno_downstream/anet_ret_val.json",
    data_root="s3://video_pub/ANet_320p_fps30/val",
    media_type="video",
    is_paragraph_retrieval=True,
    max_txt_l = 150
)
...
available_corpus["lsmdc_ret_test_1000"] = dict(
    # anno_path="your_path", 
    # data_root="",
    anno_path="/mnt/petrelfs/share_data/videointern/annotations/anno_downstream/lsmdc_ret_test_1000.json",
    data_root="s3://video_pub/LSMDC",
    media_type="video"
)
...
available_corpus["vatex_ch_ret_val"] = dict(
    # anno_path="your_path", 
    # data_root="",
    anno_path="/mnt/petrelfs/share_data/videointern/annotations/anno_downstream/vatex_ch_ret_val.json",
    data_root="",
    media_type="video"
)
...
available_corpus["vatex_en_ret_val"] = dict(
    # anno_path="your_path", 
    # data_root="",
    anno_path="/mnt/petrelfs/share_data/videointern/annotations/anno_downstream/vatex_en_ret_val.json",
    data_root="",
    media_type="video"
)
...
available_corpus["k400_act_val"] = dict(
    # anno_path="your_path", 
    # data_root="",
    anno_path="/mnt/petrelfs/share_data/videointern/annotations/anno_downstream_lkc/k400_ar_val.json", 
    data_root="p2:s3://k400",
    media_type="video",
    is_act_rec=True,
)
...
available_corpus["ssv2_mc_val"] = dict(
    # anno_path="your_path", 
    # data_root="",
    anno_path="/mnt/petrelfs/share_data/videointern/annotations/anno_downstream_lkc/ssv2_mc_val.json", 
...
available_corpus["charades_mc_test"] = dict(
    # anno_path="your_path", 
    # data_root="",
    anno_path="/mnt/petrelfs/share_data/videointern/annotations/anno_downstream_lkc/charades_mc_test.json", 
