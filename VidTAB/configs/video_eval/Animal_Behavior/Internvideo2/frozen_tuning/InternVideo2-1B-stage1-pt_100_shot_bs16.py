...
data_root = 'yourpath/video_eval/Animal_Behavior/video/'
data_root_val = data_root
ann_file_train = 'yourpath/video_eval/Animal_Behavior/train_100.txt'
ann_file_val = 'yourpath/video_eval/Animal_Behavior/val.txt'
ann_file_test = 'yourpath/video_eval/Animal_Behavior/val.txt'
