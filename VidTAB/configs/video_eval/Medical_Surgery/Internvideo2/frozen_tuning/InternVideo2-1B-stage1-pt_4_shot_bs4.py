...
data_root = 'yourpath/video_eval/Medical_Surgery/'
data_root_val = data_root
ann_file_train = 'yourpath/video_eval/Medical_Surgery/train.txt'
ann_file_val = 'yourpath/video_eval/Medical_Surgery/test.txt'
ann_file_test = 'yourpath/video_eval/Medical_Surgery/test.txt'
