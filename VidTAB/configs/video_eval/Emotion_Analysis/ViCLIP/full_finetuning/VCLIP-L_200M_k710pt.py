...
model = dict(
    ...
    backbone=dict(
        type='ViCLIP',
        pretrained='/mnt/petrelfs/lixinhao/lxh_exp/ZeroI2V/.work_dirs/recognition/vit_lyz/P001a_vit_zero_base_clip_k710_u8_200m/best_acc_top1_epoch_40.pth',
    ...
    cls_head=dict(
        ...
        blending=dict(
            ...
            augments=[
                dict(type='MixupBlending', alpha=0.8, num_classes=7),
                dict(type='CutmixBlending', alpha=1, num_classes=7)
            ]),
        format_shape='NCTHW'))
...
ann_file_train = 'yourpath/video_eval/Emotion_Analysis/train.txt'
