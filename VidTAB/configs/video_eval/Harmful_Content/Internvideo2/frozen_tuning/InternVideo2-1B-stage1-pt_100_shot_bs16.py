...
model = dict(
    ...
    backbone=dict(
        type='InternVideo2',
        pretrained="/mnt/petrelfs/share_data/likunchang/model/um_teacher/umt2/vit_g14_1.1M_CLIP+MAE_300e_pt.pth",
...
data_root = 'yourpath/video_eval/Harmful_Content/video/'
data_root_val = data_root
ann_file_train = 'yourpath/video_eval/Harmful_Content/train_100.txt'
ann_file_val = 'yourpath/video_eval/Harmful_Content/test.txt'
ann_file_test = 'yourpath/video_eval/Harmful_Content/test.txt'
