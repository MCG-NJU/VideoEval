...
class V_JEPA(nn.Module):
    ...
    def init_weights(self):
        ...
        if self.pretrained is not None:
            state_dict_old = torch.load(self.pretrained, map_location='cpu')['encoder']
            state_dict = {}
            for k in state_dict_old.keys():
                state_dict[k.replace('module.backbone.', '')] = state_dict_old[k] 
