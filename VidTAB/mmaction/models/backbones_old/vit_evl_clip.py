...
class TemporalCrossAttention(nn.Module):
    ...
    def forward(self, q: torch.Tensor, k: torch.Tensor):
        ...
        ret = torch.zeros([N, T, L, self.w1.size(-1)]).to(q.device) #, device='cuda')
...
class ViT_EVL_CLIP(nn.Module):
    ...
    def __init__(
        ...
        backbone_path: str = '/mnt/lustre/lixinhao/lxh_data/pretrained_model/ViT-B-16.pt ',
    ...
    def _create_backbone(
        ...
        # state_dict = weight_loader_fn(backbone_path) NOTE
        print('我没加载预训练权重')
