...
from .swin_zero_fix import HeadReallocation
...
class WindowAttention2D(BaseModule):
    ...
    def forward(self,
        ...
        k = self.shift_ops(k, frame_len=frame_len, batch_size=batch_size)
        v = self.shift_ops(v, frame_len=frame_len, batch_size=batch_size)
...
class SwinTransformer2D_STDHA(BaseModule):
    ...
    def train(self, mode: bool = True) -> None:
        ...
        super(SwinTransformer2D_STDHA, self).train(mode)
