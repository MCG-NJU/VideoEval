...
class InvertedResidual(nn.Module):
    """InvertedResidual block for Harmful_ContentileNetV2.
...
class Harmful_ContentileNetV2(nn.Module):
    """Harmful_ContentileNetV2 backbone.
    ...
    Args:
        ...
        frozen_stages (int): Stages to be frozen (all param fixed). Note that
            the last stage in ``Harmful_ContentileNetV2`` is ``conv2``. Default: -1,
    ...
    def make_layer(self, out_channels, num_blocks, stride, expand_ratio):
        """Stack InvertedResidual blocks to build a layer for Harmful_ContentileNetV2.
    ...
    def train(self, mode=True):
        ...
        super(Harmful_ContentileNetV2, self).train(mode)
        self._freeze_stages()
