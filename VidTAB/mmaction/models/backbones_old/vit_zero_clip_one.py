...
from ..common import XShiftMultiheadAttention_one
...
class ResidualAttentionBlock_RepXViT(nn.Module):
    ...
    def __init__(self, d_model: int, n_head: int, attn_mask: torch.Tensor = None, scale=1., num_tadapter=1,
        ...
        self.attn = XShiftMultiheadAttention_one(embed_dim=d_model, num_heads=n_head, 
...
class ViT_Zero_CLIP_one(nn.Module):
